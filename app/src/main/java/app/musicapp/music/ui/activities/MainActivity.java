...
import app.musicapp.music.dialogs.ScanMediaFolderChooserDialog;
import app.musicapp.music.glide.SongGlideRequest;
import app.musicapp.music.helper.MusicPlayerRemote;
import app.musicapp.music.helper.SearchQueryHelper;
...
import app.musicapp.music.ui.fragments.mainactivity.folders.FoldersFragment;
import app.musicapp.music.ui.fragments.mainactivity.library.LibraryFragment;
...
public class MainActivity extends AbsSlidingMusicPanelActivity {
    ...
    @Nullable
    private View navigationDrawerHeaderDefault;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == MY_REQUEST_CODE) {
            ...
            if (resultCode != RESULT_CANCELED) {
                Toast.makeText(this, "This update is much needed for Music App to work properly.",
                        Toast.LENGTH_LONG).show();
            }
    ...
    private void updateNavigationDrawerHeader() {
        if (!MusicPlayerRemote.getPlayingQueue().isEmpty()) {
            ...
            navigationDrawerHeaderDefault = navigationView.inflateHeaderView(R.layout.navigation_drawer_header_default);
        }
    }
    ...
    public void onPlayingMetaChanged() {
        ...
        assert navigationDrawerHeaderDefault != null;
        navigationView.removeHeaderView(navigationDrawerHeaderDefault);
        navigationDrawerHeaderDefault = null;
