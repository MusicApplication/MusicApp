...
import app.musicapp.music.appwidgets.AppWidgetBig;
import app.musicapp.music.appwidgets.AppWidgetCard;
import app.musicapp.music.appwidgets.AppWidgetClassic;
import app.musicapp.music.appwidgets.AppWidgetSmall;
import app.musicapp.music.glide.BlurTransformation;
import app.musicapp.music.glide.SongGlideRequest;
import app.musicapp.music.helper.ShuffleHelper;
import app.musicapp.music.helper.StopWatch;
...
import app.musicapp.music.provider.MusicPlaybackQueueStore;
import app.musicapp.music.provider.SongPlayCountStore;
import app.musicapp.music.service.notification.PlayingNotification;
...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public static final String MUSIC_APP_PACKAGE_NAME = "app.musicapp.music";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";

    public static final String ACTION_TOGGLE_PAUSE = MUSIC_APP_PACKAGE_NAME + ".togglepause";
    public static final String ACTION_PLAY = MUSIC_APP_PACKAGE_NAME + ".play";
    public static final String ACTION_PLAY_PLAYLIST = MUSIC_APP_PACKAGE_NAME + ".play.playlist";
    public static final String ACTION_PAUSE = MUSIC_APP_PACKAGE_NAME + ".pause";
    public static final String ACTION_STOP = MUSIC_APP_PACKAGE_NAME + ".stop";
    public static final String ACTION_SKIP = MUSIC_APP_PACKAGE_NAME + ".skip";
    public static final String ACTION_REWIND = MUSIC_APP_PACKAGE_NAME + ".rewind";
    public static final String ACTION_QUIT = MUSIC_APP_PACKAGE_NAME + ".quitservice";
    public static final String ACTION_PENDING_QUIT = MUSIC_APP_PACKAGE_NAME + ".pendingquitservice";
    public static final String INTENT_EXTRA_PLAYLIST = MUSIC_APP_PACKAGE_NAME + "intentextra.playlist";
    public static final String INTENT_EXTRA_SHUFFLE_MODE = MUSIC_APP_PACKAGE_NAME + ".intentextra.shufflemode";

    public static final String APP_WIDGET_UPDATE = MUSIC_APP_PACKAGE_NAME + ".appwidgetupdate";
    public static final String EXTRA_APP_WIDGET_NAME = MUSIC_APP_PACKAGE_NAME + "app_widget_name";

    // do not change these three strings as it will break support with other apps (e.g. last.fm scrobbling)
    public static final String META_CHANGED = MUSIC_APP_PACKAGE_NAME + ".metachanged";
    public static final String QUEUE_CHANGED = MUSIC_APP_PACKAGE_NAME + ".queuechanged";
    public static final String PLAY_STATE_CHANGED = MUSIC_APP_PACKAGE_NAME + ".playstatechanged";

    public static final String REPEAT_MODE_CHANGED = MUSIC_APP_PACKAGE_NAME + ".repeatmodechanged";
    public static final String SHUFFLE_MODE_CHANGED = MUSIC_APP_PACKAGE_NAME + ".shufflemodechanged";
    public static final String MEDIA_STORE_CHANGED = MUSIC_APP_PACKAGE_NAME + ".mediastorechanged";
    ...
    public void onCreate() {
        ...
        sendBroadcast(new Intent("app.musicapp.music.PHONOGRAPH_MUSIC_SERVICE_CREATED"));
    }
    ...
    public void onDestroy() {
        ...
        sendBroadcast(new Intent("app.musicapp.music.PHONOGRAPH_MUSIC_SERVICE_DESTROYED"));
    }
    ...
    private void sendPublicIntent(@NonNull final String what) {
        final Intent intent = new Intent(what.replace(MUSIC_APP_PACKAGE_NAME, MUSIC_PACKAGE_NAME));
        ...
        intent.putExtra("scrobbling_source", MUSIC_APP_PACKAGE_NAME);
